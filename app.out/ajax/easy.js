...
var G__7349 = format;
var G__7349__$1 = (((G__7349 instanceof cljs.core.Keyword))?G__7349.fqn:null);
switch (G__7349__$1) {
case "transit":
return ajax.transit.transit_request_format.cljs$core$IFn$_invoke$arity$1(format_params);
...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.first(format),(function (){var G__7351 = cljs.core.second(format);
var G__7352 = format_params;
return (ajax.easy.keyword_response_format_element.cljs$core$IFn$_invoke$arity$2 ? ajax.easy.keyword_response_format_element.cljs$core$IFn$_invoke$arity$2(G__7351,G__7352) : ajax.easy.keyword_response_format_element.call(null,G__7351,G__7352));
})()], null);
} else {
if(cljs.core.map_QMARK_(format)){
return format;
...
if(cljs.core.vector_QMARK_(format)){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.vector,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__7355_SHARP_){
return ajax.easy.keyword_response_format_element(p1__7355_SHARP_,format_params);
}),format));
} else {
 ...
 */
ajax.easy.transform_handler = (function ajax$easy$transform_handler(p__7356){
...
var handler = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__7357__$1,cljs.core.cst$kw$handler);
var error_handler = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__7357__$1,cljs.core.cst$kw$error_DASH_handler);
var finally$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__7357__$1,cljs.core.cst$kw$finally);
...
return ((function (h,e,map__7357,map__7357__$1,handler,error_handler,finally$){
return (function ajax$easy$transform_handler_$_easy_handler(p__7359){
var vec__7360 = p__7359;
var ok = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__7360,(0),null);
var result = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__7360,(1),null);
var fexpr__7363_7364 = (cljs.core.truth_(ok)?h:e);
(fexpr__7363_7364.cljs$core$IFn$_invoke$arity$1 ? fexpr__7363_7364.cljs$core$IFn$_invoke$arity$1(result) : fexpr__7363_7364.call(null,result));
...
;})(h,e,map__7357,map__7357__$1,handler,error_handler,finally$))
});
ajax.easy.transform_opts = (function ajax$easy$transform_opts(p__7365){
var map__7366 = p__7365;
var map__7366__$1 = (((((!((map__7366 == null))))?(((((map__7366.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__7366.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__7366):map__7366);
var opts = map__7366__$1;
var method = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__7366__$1,cljs.core.cst$kw$method);
var format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__7366__$1,cljs.core.cst$kw$format);
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__7366__$1,cljs.core.cst$kw$response_DASH_format);
var params = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__7366__$1,cljs.core.cst$kw$params);
var body = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__7366__$1,cljs.core.cst$kw$body);
