...
var G__6585 = format;
var G__6585__$1 = (((G__6585 instanceof cljs.core.Keyword))?G__6585.fqn:null);
switch (G__6585__$1) {
case "transit":
return ajax.transit.transit_request_format.cljs$core$IFn$_invoke$arity$1(format_params);
...
return new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.first(format),(function (){var G__6587 = cljs.core.second(format);
var G__6588 = format_params;
return (ajax.easy.keyword_response_format_element.cljs$core$IFn$_invoke$arity$2 ? ajax.easy.keyword_response_format_element.cljs$core$IFn$_invoke$arity$2(G__6587,G__6588) : ajax.easy.keyword_response_format_element.call(null,G__6587,G__6588));
})()], null);
} else {
if(cljs.core.map_QMARK_(format)){
return format;
...
var G__6589 = format;
var G__6589__$1 = (((G__6589 instanceof cljs.core.Keyword))?G__6589.fqn:null);
switch (G__6589__$1) {
case "transit":
...
if(cljs.core.vector_QMARK_(format)){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.vector,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__6591_SHARP_){
return ajax.easy.keyword_response_format_element(p1__6591_SHARP_,format_params);
}),format));
} else {
 ...
 */
ajax.easy.transform_handler = (function ajax$easy$transform_handler(p__6592){
var map__6593 = p__6592;
var map__6593__$1 = (((((!((map__6593 == null))))?(((((map__6593.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__6593.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__6593):map__6593);
var handler = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__6593__$1,cljs.core.cst$kw$handler);
var error_handler = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__6593__$1,cljs.core.cst$kw$error_DASH_handler);
var finally$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__6593__$1,cljs.core.cst$kw$finally);
...
return ((function (h,e,map__6593,map__6593__$1,handler,error_handler,finally$){
return (function ajax$easy$transform_handler_$_easy_handler(p__6595){
var vec__6596 = p__6595;
var ok = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__6596,(0),null);
var result = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__6596,(1),null);
var fexpr__6599_6600 = (cljs.core.truth_(ok)?h:e);
(fexpr__6599_6600.cljs$core$IFn$_invoke$arity$1 ? fexpr__6599_6600.cljs$core$IFn$_invoke$arity$1(result) : fexpr__6599_6600.call(null,result));
...
;})(h,e,map__6593,map__6593__$1,handler,error_handler,finally$))
});
ajax.easy.transform_opts = (function ajax$easy$transform_opts(p__6601){
var map__6602 = p__6601;
var map__6602__$1 = (((((!((map__6602 == null))))?(((((map__6602.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__6602.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__6602):map__6602);
var opts = map__6602__$1;
var method = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__6602__$1,cljs.core.cst$kw$method);
var format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__6602__$1,cljs.core.cst$kw$format);
var response_format = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__6602__$1,cljs.core.cst$kw$response_DASH_format);
var params = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__6602__$1,cljs.core.cst$kw$params);
var body = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__6602__$1,cljs.core.cst$kw$body);
